...
# model_sparse = aot_module(model_sparse, fw_compiler=ts_compile, bw_compiler=ts_compile)

tvm_compiler = tvm_compile(target="cuda")
model_sparse = aot_module(model_sparse, fw_compiler=tvm_compiler, bw_compiler=tvm_compiler)
