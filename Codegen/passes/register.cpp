...
Value* graph_rewrite_helper::getValue(
...
std::string graph_rewrite_helper::getFuncName(Value* func_value) {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m){
    m.def("fuse_linear_v2", &torch::jit::FuseLinearV2, "fuse linear and bias in cuda graph");
}