...
template <
    ...
    int PartitionsK_ = 1>
class SparseMmaTensorOpMetaTileIteratorTrans {
 public:
 ...
 public:
  ...
  CUTLASS_HOST_DEVICE
  SparseMmaTensorOpMetaTileIteratorTrans()
      : pointer_(nullptr),
        stride_(0),
        byte_offset_(0),
        k_group_idx_(0) {}
  ...
  CUTLASS_DEVICE
  SparseMmaTensorOpMetaTileIteratorTrans &add_pointer_offset(LongIndex offset) {
  ...
  CUTLASS_DEVICE
  SparseMmaTensorOpMetaTileIteratorTrans &operator++() {
    add_tile_offset({1, 0});
  ...
  ///< the tensor
  CUTLASS_DEVICE SparseMmaTensorOpMetaTileIteratorTrans &
