#include "mma_sparse_multistage.h"
////////////////////////////////////////////////////////////////////////////////
...
template <
    ...
    typename Operator
    >
struct DefaultSparseMmaV2<ElementA, LayoutA, kAlignmentA, ElementB, LayoutB,
  ...
  using ThreadblockMma = cutlass::gemm::threadblock::SparseMmaMultistageV2<
