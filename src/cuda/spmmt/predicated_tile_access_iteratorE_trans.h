...
// private:
 ...
 public:
  ...
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorETransPredicates &operator++() {
...
/// PredicatedTileAccessIteratorETrans
///
template <typename Shape, typename Element, typename Layout, int AdvanceRank,
          typename ThreadMap, typename AccessType>
class PredicatedTileAccessIteratorETrans;

////////////////////////////////////////////////////////////////////////////////

/// Specialization of PredicatedTileAccessIteratorETrans for pitch-linear data.
///
template <typename Shape_, typename Element_, int AdvanceRank,
          typename ThreadMap_, typename AccessType_>
class PredicatedTileAccessIteratorETrans<Shape_, Element_, layout::PitchLinear,
 ...
 public:
  ...
  using UnderlyingPredicates = PredicatedTileAccessIteratorETransPredicates<
 ...
 public:
  ...
  /// Construct a PredicatedTileAccessIteratorETrans with zero threadblock offset
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorETrans(
      /// Precomputed parameters object
      Params const &params,
      ...
      ///< ID of each participating thread
      int thread_id)
      : PredicatedTileAccessIteratorETrans(params, pointer, extent, thread_id,
                                     make_Coord(0, 0)) {}
  ...
  /// Increment and return an instance to self.
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorETrans &operator++() {
  ...
  /// Increment and return an instance to self.
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorETrans operator++(int) {
    PredicatedTileAccessIteratorETrans self(*this);
    operator++();
    return self;
  }
...
/// Specialization of PredicatedTileAccessIteratorETrans for column-major interleaved data.  
...
class PredicatedTileAccessIteratorETrans<Shape_, Element_,
 ...
 public:
  ...
  using UnderlyingIterator = PredicatedTileAccessIteratorETrans<
  ...
  class Params {
   private:
    friend PredicatedTileAccessIteratorETrans;
