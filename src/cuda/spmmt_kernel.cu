...
using WarpShape_f16 = cutlass::gemm::GemmShape<64, 64, 64>;
...
using Mma_f16_ntn = typename cutlass::gemm::threadblock::DefaultSparseMmaV2<
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The spmmt_nnn kernel to handle sparse backward pass
/////////////////////////////////////////////////////////////////////////////////////////////////////////////

using InstructionShape_bf16_sp = cutlass::gemm::GemmShape<16, 8, 16>;

using Mma_bf16_nnn = typename cutlass::gemm::threadblock::DefaultMmaV2<
    cutlass::bfloat16_t, cutlass::layout::RowMajor, 128 / cutlass::sizeof_bits<cutlass::bfloat16_t>::value,
    cutlass::bfloat16_t, cutlass::layout::RowMajor, 128 / cutlass::sizeof_bits<cutlass::bfloat16_t>::value,
    float, cutlass::layout::RowMajor, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm80,
    ThreadblockShape_bf16, WarpShape_bf16, InstructionShape_bf16_sp, NumStages, cutlass::arch::OpMultiplyAdd>::ThreadblockMma;
