...
torch::Tensor spmmv2_bf16_ntn(
    ...
    const float alpha)
{
    return spmmv2_bf16_ntn_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmv2_bf16_ntt(
    ...
    const float alpha)
{
    return spmmv2_bf16_ntt_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmv2_f16_nnn(
    ...
    const float alpha)
{
    return spmmv2_f16_nnn_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmv2_f16_ntn(
    ...
    const float alpha)
{
    return spmmv2_f16_ntn_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmv2_f16_ntt(
    ...
    const float alpha)
{
    return spmmv2_f16_ntt_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
