...
@compatibility(is_backward_compatible=True)
def replace_pattern_(gm: GraphModule, pattern: Callable, replacement: Callable) -> List[Match]:
    """
    ...
    .. code-block:: python
        def forward(self, x, w1, w2):
            ...
            return add_2
    """
    from passes.utils.matcher_utils import SubgraphMatcher, InternalMatch
