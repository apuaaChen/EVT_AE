...
// private:
 ...
 public:
  ...
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorV3Predicates &operator++() {
...
/// PredicatedTileAccessIteratorV3
///
template <typename Shape, typename Element, typename Layout, int AdvanceRank,
          typename ThreadMap, typename AccessType>
class PredicatedTileAccessIteratorV3;

/// Specialization of PredicatedTileAccessIteratorV3 for pitch-linear data.
///
template <typename Shape_, typename Element_, int AdvanceRank,
          typename ThreadMap_, typename AccessType_>
class PredicatedTileAccessIteratorV3<Shape_, Element_, layout::PitchLinear,
 ...
 public:
  ...
  using UnderlyingPredicates = PredicatedTileAccessIteratorV3Predicates<
 ...
 public:
  ...
  /// Construct a PredicatedTileAccessIteratorV3 with zero threadblock offset
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorV3(
      /// Precomputed parameters object
      Params const &params,
      ...
      ///< ID of each participating thread
      int thread_id)
      : PredicatedTileAccessIteratorV3(params, pointer, extent, thread_id,
                                     make_Coord(0, 0)) {}
  ...
  /// Increment and return an instance to self.
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorV3 &operator++() {
  ...
  /// Increment and return an instance to self.
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorV3 operator++(int) {
    PredicatedTileAccessIteratorV3 self(*this);
    operator++();
    return self;
  }
...
/// Specialization of PredicatedTileAccessIteratorV3 for column-major data.
///
...
template <typename Shape_, typename Element_, int AdvanceRank,
          typename ThreadMap_, typename AccessType_>
class PredicatedTileAccessIteratorV3<Shape_, Element_, layout::ColumnMajor,
                                   AdvanceRank, ThreadMap_, AccessType_> {
 public:
  static_assert(
      AdvanceRank == 0 || AdvanceRank == 1,
  ...
  using UnderlyingIterator = PredicatedTileAccessIteratorV3<
  ...
  class Params {
   private:
    friend PredicatedTileAccessIteratorV3;
