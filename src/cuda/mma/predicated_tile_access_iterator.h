...
// private:
 ...
 public:
  ...
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorPredicatesV2 &operator++() {
...
/// PredicatedTileAccessIteratorV2
///
template <typename Shape, typename Element, typename Layout, int AdvanceRank,
          typename ThreadMap, typename AccessType>
class PredicatedTileAccessIteratorV2;

////////////////////////////////////////////////////////////////////////////////

/// Specialization of PredicatedTileAccessIteratorV2 for pitch-linear data.
///
template <typename Shape_, typename Element_, int AdvanceRank,
          typename ThreadMap_, typename AccessType_>
class PredicatedTileAccessIteratorV2<Shape_, Element_, layout::PitchLinear,
 ...
 public:
  ...
  using UnderlyingPredicates = PredicatedTileAccessIteratorPredicatesV2<
 ...
 public:
  ...
  /// Construct a PredicatedTileAccessIteratorV2 with zero threadblock offset
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorV2(
      /// Precomputed parameters object
      Params const &params,
      ...
      ///< ID of each participating thread
      int thread_id)
      : PredicatedTileAccessIteratorV2(params, pointer, extent, thread_id,
                                     make_Coord(0, 0)) {}
  ...
  /// Increment and return an instance to self.
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorV2 &operator++() {
  ...
  /// Increment and return an instance to self.
  CUTLASS_HOST_DEVICE
  PredicatedTileAccessIteratorV2 operator++(int) {
    PredicatedTileAccessIteratorV2 self(*this);
    operator++();
    return self;
  }
...
/// Specialization of PredicatedTileAccessIteratorV2 for row-major data.
///
...
template <typename Shape_, typename Element_, int AdvanceRank,
          typename ThreadMap_, typename AccessType_>
class PredicatedTileAccessIteratorV2<Shape_, Element_, layout::RowMajor,
                                   AdvanceRank, ThreadMap_, AccessType_> {
 public:
  static_assert(
      AdvanceRank == 0 || AdvanceRank == 1,
  ...
  using UnderlyingIterator = PredicatedTileAccessIteratorV2<
  ...
  class Params {
   private:
    friend PredicatedTileAccessIteratorV2;
