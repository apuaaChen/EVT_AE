...
torch::Tensor spmmt_bf16_ntn(
    ...
    const float alpha)
{
    return spmmt_bf16_ntn_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmt_bf16_ntt(
    ...
    const float alpha)
{
    return spmmt_bf16_ntt_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmt_f16_ntn(
    ...
    const float alpha)
{
    return spmmt_f16_ntn_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmt_f16_ntt(
    ...
    const float alpha)
{
    return spmmt_f16_ntt_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmt_bf16_nnn(
    ...
    const float alpha)
{
    return spmmt_bf16_nnn_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmt_bf16_nnt(
    ...
    const float alpha)
{
    return spmmt_bf16_nnt_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmt_f16_nnn(
    ...
    const float alpha)
{
    return spmmt_f16_nnn_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
...
torch::Tensor spmmt_f16_nnt(
    ...
    const float alpha)
{
    return spmmt_f16_nnt_cuda(tensor_a_, tensor_b_, tensor_e_, alpha);
}
